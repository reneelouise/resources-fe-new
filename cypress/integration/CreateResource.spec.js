describe("Testing the CreateNewResource component", () => {
  ...
  it("Checks that the recommendation type has 3 radio buttons and the required labels", () => {
    ...
    cy.get('.recommendation-type-item').contains('I recommend this resource after having used it');
    cy.get('.recommendation-type-item').contains('I do not recommend this resource, having used it');
    cy.get('.recommendation-type-item').contains(`I haven't used this resource but it looks promising`);
  });
